...
const arr5 = new Array (1, 2, 3); // Arrat생성자함수, 크기가3인
console.log(arr5.length);
console.log(arr5);

const arr6 = Array.of(1);//Array.of 메소드
console.log(arr6.length);
console.log(arr6);

const arr7 = Array.of(1, 2, 3);//Array.of 메소드
console.log(arr7.length);//3
console.log(arr7);//[ 1, 2, 3 ]

//Array from 인자로 유사배열객체
const arr8 = Array.from({length:2, 0:'a' , 1:'b'});//Array.of 메소드
console.log(arr8.length);//2
console.log(arr8);//[ 'a', 'b' ]

//Arrat.from 인자로 리터러블
const arr9 = Array.from('babo');//Array.of 메소드
console.log(arr9.length);//4
console.log(arr9);//[ 'b', 'a', 'b', 'o' ]
