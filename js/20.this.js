//this: 메모리상 현재 참조되고 있는 객체 자신
//       객체의 참조를 저장하고 있는 객체참조변수
console.log(this); // {} : 노드환경에서 전역객체, 웹브라우저환경에서는 window
...
// 3.생성자함수 호출방식으로 호출: this 는 생성자 함수를 통해 생성될 객체
new Car();//this는 car{}
...
//bind : this를 함수 호출시점에 바인딩함, this바인딩된 함수를 반환
