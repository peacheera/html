...
console.log('노드 값 : ', mainTitle.nodeType); 
console.log('노드 이름 : ', mainTitle.nodeName); 
...
//요소의 속성들
//유사배열객체
//NamedNodeMap0: id1: classclass: classid: idlength: 2[[Prototype]]: NamedNodeMap
...
console.log('classList : ', mainTitle);
...
newItem.textContent = 'Item 5';  // 'newItem'을 사용해야 합니다.
newItem.dataset.id = '5';
newItem.dataset.name = 'Item5';
list.appendChild(newItem);

//DoucmentFragment :독립된 문서객체 (DOM트리를 벗어난 새로운 DOM), 직독직해: 문서조각
