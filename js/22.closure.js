...
//이때 이미 종료된 outer함수의 변수에 접근할 수있는 중첩함수인
//inner를 outer의 클로져라고 부른다
...
const innerFunc = outer();// outer실행 종료
innerFunc();//10 outer의 x를 참조할 수 있음

//클로져의 활용
//counter변수를 즉시실행함수에 가둬서(정보은닉, 캡슐화)
//외부에서 counter변수에 접근하는 것을 차단
//즉, increase, decrease 함수를 통해서만 접근 가능하도록 하기위함
const counter = (function(){// function함수 즉시 호출
