//정규표현식 객체생성
const regExp = /abc/i;  // 대소문자 구별없이 a-> b -> c가 순서대로 오는 패턴
...
console.log(regExp4.exec(str));//[ 'ab', index: 4, input: 'ab, abc, ab', groups: undefined ]
...
//반복회수
console.log(str2.match(/a{2}/g));//['aa', 'aaa']
...
//숫자하나 = \d
console.log(str2.match(/[0-9]/g));//nill
//영문자 하나 = \w
console.log(str2.match(/[a-zA-z]/g));//['a', 'a', 'b', 'a', 'a','a', 'b', 'c', 'a', 'a','a', 'a', 'c', 'a', 'b','c', 'd']
//워드(영대소문자 또는_하나)
console.log(str2.match(/[a-zA-z_]/g));
//공백문자 하나 = \s
